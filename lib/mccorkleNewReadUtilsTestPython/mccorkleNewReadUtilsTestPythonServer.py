...
import os
from mccorkleNewReadUtilsTestPython.authclient import KBaseAuth as _KBaseAuth
...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'mccorkleNewReadUtilsTestPython'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from mccorkleNewReadUtilsTestPython.mccorkleNewReadUtilsTestPythonImpl import mccorkleNewReadUtilsTestPython  # @IgnorePep8
impl_mccorkleNewReadUtilsTestPython = mccorkleNewReadUtilsTestPython(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_mccorkleNewReadUtilsTestPython.filter_contigs,
                ...
                try:
                    ...
                    if auth_req != 'none':
                        if token is None and auth_req == 'required':
                            err = JSONServerError()
                            err.data = (
                                'Authentication required for mccorkleNewReadUtilsTestPython ' +
