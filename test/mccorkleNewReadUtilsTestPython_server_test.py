...
from mccorkleNewReadUtilsTestPython.mccorkleNewReadUtilsTestPythonImpl import mccorkleNewReadUtilsTestPython
from mccorkleNewReadUtilsTestPython.mccorkleNewReadUtilsTestPythonServer import MethodContext


class mccorkleNewReadUtilsTestPythonTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'mccorkleNewReadUtilsTestPython',
        ...
        for nameval in config.items('mccorkleNewReadUtilsTestPython'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = mccorkleNewReadUtilsTestPython(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_mccorkleNewReadUtilsTestPython_" + str(suffix)
